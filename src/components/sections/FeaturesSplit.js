...
const FeaturesSplit = ({
  ...
  const sectionHeader = {
    ...
    paragraph: "Since I have been mainly focusing on problem-solving, I haven't made many projects but yeah in near future, I'll be building more web apps and more cool projects"
  };
          ...
          <div className={splitClasses}>
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-right" data-reveal-container=".split-item">
                ...
                <a href="https://github.com/theiconik/pwd-pkg/"><h3 className="mt-0 mb-12">
                  pwd-pkg
                  </h3></a>
                <p className="m-0">
